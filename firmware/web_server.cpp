...
const char *mainPage =
    ...
    "<h1>Makerfabs</h1><br><h2>SenseLora Soil Moisture</h2><br>"
...
void main_page_html(WiFiClient *client)
{
    ...
    client->print("<h1>Makerfabs</h1><br><h2>SenseLora Soil Moisture</h2><br>");
    ...
    client->print("<table border=\"2\"><tr><td>ADC</td><td>Battery</td>");
    client->print("</tr><td>");//<td>P(mg/Kg)</td><td>K(mg/Kg)</td><tr>
    client->print((int)analogValue);
    client->print("</td><td>");
    client->print((int)bat_vol);
//    client->print("</td><td>");
//    client->print((int)analogVolts);
//    client->print("</td><td>");
